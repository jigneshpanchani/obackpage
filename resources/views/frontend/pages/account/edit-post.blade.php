                ...
                <div class="px-6 space-y-6">
                    ...
                    <div class="flex grid grid-cols-3 gap-10 px-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectCountry" value="{{(empty($data['continent_id']) ? null : $data['continent_id'])}}"  name="continent_id" id="country-dropdown">
                    ...
                    <div class="space-y-6 px-6 pb-6 w-2/3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea  value="{{$data['description']}}"  id="description h-40"  name="description" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
