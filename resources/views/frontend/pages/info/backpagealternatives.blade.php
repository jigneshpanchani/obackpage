...
@section('title', 'Backpage Alternatives - obackpage.com')
...
<div class="">
        <div class="flex px-0 xl:px-60">
            <div class="flex flex-col w-full p-4">
                ...
                <div class="col-md-12">
                    <div class="flex justify-center p-4"><span class="text-gray-800 text-2xl font-bold">Backpage Alternatives</span></div>
                    <div class="flex justify-between w-full items-center border-b-2 border-gray-400"></div><br>
                    <div class="concls text-sm font-bold">
                        <p>
                            Do you even know about the <a class="text-gray-700 underline" href="{{ route('alternative-to-backpage') }}">Backpage Alternatives</a>? Let’s know about the Backpage Alternative,
                            Alternative to Backpage and Backpage Replacement as well. Obackpage is the biggest <a class="text-gray-700 underline" href="{{ route('backpage-replacement') }}">Backpage Replacement</a> now I have ever seen! Ask me how? This is your biggest question and your answer is here.
                        </p>
                        <br>
                        <p>
                            Are you trying to find the simplest backpage alternative websites? Well, you are not alone! obackpage is
                            here to make you satisfied like Backpages. Once reigned supreme because the perfect online destination
                            for classified or personal ads, backpage had everything be it electronics, events, vacancy alerts, land , and
                        ...
                        <br>
                        <div class="font-bold text-xl">Let’s know Backpage Alternatives</div><br>
                        <p>
                            When Backpage.com totally shut down, then all the web users collectively went on the look for
                            subsequent. Legally the classified ad platforms on the online. And therein spirit, here’s a better check
                            out the highest 10 best and extraordinarily reliable <a class="text-gray-700 underline" href="{{ route('alternative-to-backpage') }}">Backpage Alternatives</a> websites to
                            <a class="font-bold">obackpage</a> that we expect provides the simplest experiences – but sans the deceit, gross crimes,
                        ...
                        <br>
                        <div class="font-bold text-xl">Which are the Backpage Alternatives?</div><br>
                        <p>
                            <ol>
                        ...
                        <ol>
                            ...
                            <li>&emsp;2.&emsp;2backpage.com</li><br>
                            <li>&emsp;3.&emsp;starbackpage.com</li><br>
                        </ol>
                        <br>
                        <div class="font-bold text-xl">Why You Will Use obackpage?</div><br>
                        <p>
                            <ol>
                        ...
                        <br>
                        <div class="font-bold text-lg">Services:</div><br>
                        <ul>
                        ...
                        <p>
                            ...
                            enforcement stings. However, the women want to attach for free of charges. Obackpage is nothing
                        ...
                        <br>
                        <p>
                            Since <a class="text-gray-700 underline" href="{{ route('home') }}">obackpage.com</a> may be a regular dating site, expect ordinary girls with typical profiles, unlike
                        ...
                        <br>
                        <div class="font-bold text-lg">Obackpage sports the following filters:</div><br>
                        <ol>
                        ...
                        <br>
                        <div class="font-bold text-lg">Pros:</div><br>
                        <ol>
