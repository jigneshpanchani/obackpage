...
@section('title', 'Similar to Backpage - obackpage.com')
...
<div class="">
        <div class="flex px-0 xl:px-60">
            <div class="flex flex-col w-full p-4">
                ...
                <div class="col-md-12">
                    <div class="flex justify-center p-4"><span class="text-gray-800 text-2xl font-bold">Similar to Backpage</span></div>
                    <div class="flex justify-between w-full items-center border-b-2 border-gray-400"></div><br>
                    <div class="concls text-sm font-bold">
                        <p>
                            obackpage is the best site <a class="text-gray-700 underline" href="{{ route('website-similar-to-backpage') }}">Similar to Backpage</a>. Are trying to find the simplest backpage alternative
                            ...
                            it electronics, events, vacancy alerts, land , and more. But from later, the location also became a hotbed for
                            questionable adult contents. Obviously, the feds weren’t thrilled! So after more allegations surfaced that
                            were happening behind all the digital-seams, the govt finally pulled the connect fall, getting the FBI to
                            destroy the location permanently .
                        </p>
                        <br>
                        <p>
                            But wait a while, does the age of backpages and like the websites are finally really over, and totally
                            done for?
                        </p>
                        <br>
                        <div class="font-bold text-xl">Similar to Backpage websites</div><br>
                        <p>
                            ...
                            out the highest 10 best and extraordinarily reliable <a class="text-gray-700 underline" href="{{ route('website-similar-to-backpage') }}">Similar to Backpage</a> websites to Obackpage
                            that we expect provides the simplest experiences – but sans the deceit, gross crimes, and
                            untrustworthiness. Before urging the list, please make sure to have a glance at the emerging
                            backpage alternative websites as well.
                        </p>
                        <br>
                        <div class="font-bold text-xl">What are the Best sites <a class="text-gray-700 underline" href="{{ route('website-similar-to-backpage') }}">Similar to Backpage</a>?</div><br>
                        <p>
                            <ol>
                        ...
                        <br>
                        <div class="font-bold text-xl">Which are the Top 3 Similar to Backpage?</div><br>
                        <p>
                            <ol>
                            <li>&emsp;1.&emsp;<a class="text-gray-700 underline" href="{{ route('home') }}">obackpage.com</a></li><br>
                            <li>&emsp;2.&emsp;<a class="text-gray-700 underline" href="#">2backpage.com</a></li><br>
                            <li>&emsp;3.&emsp;<a class="text-gray-700 underline" href="#">starbackpage.com</a></li><br>
                        </ol>
                        </p>
                        <br>
                        <div class="font-bold text-xl">Which is the Similar to Backpage for Getting Laid?</div><br>
                        <p>
                            <a class="font-bold">obackpage</a> is that the #1 Backpage replacement thanks to a lower risk of security. No pimps. No
                            enforcement stings. However, the women want to attach for free of charges. <a class="font-bold">obackpage</a> is nothing
                        ...
                        <br>
                        <div class="font-bold text-lg">Obackpage sports the following filters:</div>
                        <br>
                        <p>
                            <ol>
                        ...
                        <br>
                        <div class="font-bold text-lg">Pros:</div>
                        <br>
                        <ol>
                        ...
                        <p>
                            ...
                            userbase on <a class="text-gray-700 underline" href="{{ route('home') }}">obackpage</a> might offer which were.
                        </p>
                        <br>
                        <p>
                            Back page got finished run with dust bonnie posing as those who wanted to rub two nickels together.
                            obackpage there has been jaw falling stunning females with some money. That the lads are elderly,
                        ...
                        <br>
                        <div class="font-bold text-lg">Features:</div><br>
                        <p>
                            <ol>
                        ...
                        <br>
                        <div class="font-bold text-xl">Why will obackpage be your best choice?</div><br>
                        <p>
                            <ol>
                        ...
                        <br>
                        <p>
                            The homepage shows abilities inside your town. The majority of them show that their facesand a
                            couple blur out, leaving a way of puzzle.
                        </p>
                        <br>
                        <div class="font-bold text-lg">Detailed characteristic classifications:</div><br>
                        <p>
                            <ol>
                        ...
                        <ol>
                            ...
                            <li>&emsp;4.&emsp;Contact informations – Shows numbers, phone emails, website, Twitter handle.</li><br>
                        </ol>
                        </p>
                    </div>
                </div>
