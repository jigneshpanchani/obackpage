...
@section('content')
    ...
    <div class="concls text-sm bg-gray-200 w-full py-2 px-10 font-semibold  text-justify">
        {{-- <div class="concls text-sm"> --}}
            ...
            <p>obackpage.com is that the replacement for backpage wherever you'll post free classified advertisements to push your businesses or services on the net. Thousands of normal users ar mistreatment the particular #1 <a class="font-bold text-red-700 underline" href="{{ route('backpage-replacement') }}">backpage replacement</a> web site, obackpage classifieds to post free classified advertisements. As associate degree alternative to backpage, obackpage feels and seems specifically just like the original backpage.com.</p>
